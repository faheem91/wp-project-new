...
<div class="content">
	<div id="invitations" class=" inbox-null">
		...
		<form action="<?php echo base_url();?>index.php/connections/connection/acceptfriend" method="post" name="process" id="add-friend">
			
				
			<input type="hidden" name="friendid" value=<?php echo $item->userid; ?> />
				<ul id="control_gen_15">
			
			
				<li class="person">
					<img class="photo" width="40" height="40" alt="No Photo" src="<?php echo 'uploads/100_'.$item->imageUrl.'.jpg' ?>" />
					<div class="content">
						...
						<ul class="inbox-actions">
							<li>	
								...
								<button class="btn-ternary invite-dialog" title="Invite <?php echo $item->fname ?> to connect" type="submit" value=<?php echo $item->userid ?> name="addignore">Connect</button>
							</li>
							<li>
