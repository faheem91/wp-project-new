...
<body id="join">
	<div class="top-menu">
		<div class="wrapper">
			<a href="index.php" class="logo-black">LinkedIn</a>
				...
				<div id="content">
					...
					<div id="extra">
						<div class="sign-in-with">
							...
							<p><a href="index.php" class="fb_button"><span class="fb_button_text">Sign up with Facebook</span></a></p>
						</div>
					</div>
				</div>
				<p id="agreement">
				 * By joining LinkedIn, you agree to LinkedIn's <a href="index.php" target="_blank">User Agreement</a>, <a href="index.php" target="_blank">Privacy Policy</a> and <a href="index.php" target="_blank">Cookie Policy</a>
				</p>			
			</div>
