					...
					<form action="<?php echo base_url();?>index.php/search/search/redirecttoconfirm" method="post" name="process" id="add-friend">
						<ol id="results" class="search-results">
							...
							<li class="mod result people">
								<a href=""><img class="entity-img" width="60" height="60" src=<?php echo base_url(); echo 'uploads/100_'.$item->imageUrl.'.jpg' ?> /></a>
								<div class="bd">
									<h3>
									...
									<?php if ($item->jobTitle==NULL){?>
									<p class="description">Student at <?php echo $item->name ?></p>
									<?php } ?>
									<?php if ($item->jobTitle!=NULL){ ?>
									<p class="description"><?php echo $item->jobTitle?> at <?php echo $item->companyName ?></p>
									<?php } ?>
